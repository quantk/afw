...
final class PrevMigrationStrategyTest extends TestCase
{
    /**
    ...
    public function testPrepareVersions()
    {
        ...
        static::assertSame(array_reverse($versions), $preparedVersions);
    }
    ...
    protected function setUp()
    {
        ...
        $this->strategy = new PrevMigrationStrategy($mode, $this->connection, $this->filesystem, $this->reflector, '/', 'App');
    }
}